...
export const buildSystemPrompt = (spec: SubagentSpec, workspace: WorkspaceInfo): string => {
  const sections: string[] = [
    ...
    'The captain may queue steering while you run. It is delivered at the next safe',
    'process boundary in this same session/worktree; apply it before treating your',
    'next response as final.',
    '',
