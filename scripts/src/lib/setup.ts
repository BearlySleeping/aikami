 ...
 *
 * Usage:
 *   bun run scripts/src/lib/setup.ts        # Full interactive setup
...
# Generated by setup script — see scripts/src/lib/setup.ts
...
function printNextSteps() {
  ...
  console.log(`  ${DIM}knowledge/CONTEXT.md${RESET}      AI briefing — read this first`);
  console.log(`  ${DIM}knowledge/llms.txt${RESET}         Full knowledge index`);
  console.log(`  ${DIM}knowledge/contracts/INDEX.md${RESET} Feature contracts`);
  console.log(`  ${DIM}knowledge/guides/STACK.md${RESET}   Tech stack reference`);
  console.log('');
}
