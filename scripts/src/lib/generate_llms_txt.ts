...
/**
 * Generate knowledge/llms.txt — AI-first index of all markdown files in knowledge/.
...
const OUTPUT = join(KNOWLEDGE_DIR, 'llms.txt');
...
function generate(): string {
  const files = walk(KNOWLEDGE_DIR, KNOWLEDGE_DIR);
