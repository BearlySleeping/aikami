...
// OUTPUT_CATALOG removed — catalog is now derived at runtime via buildLpcCatalog in @aikami/lpc.
...
// ── Catalog generation ────────────────────────────────────────────────────
// Catalog generation removed — catalog is now derived at runtime via
// buildLpcCatalog in @aikami/lpc. The collector only produces assets,
// credits, and the manifest.
