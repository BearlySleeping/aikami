...
const WATCH_TARGETS = [
  ...
  join(ops, 'emberwatch_house_authoring.ts'),
  join(ops, 'emberwatch_map_authoring_helpers.ts'),
  join(ops, 'emberwatch_map_village.ts'),
  join(ops, 'emberwatch_map_retained.ts'),
  join(ops, 'emberwatch_map_shared.ts'),
  join(ops, 'generate_emberwatch_atlas.ts'),
  join(ops, 'generate_emberwatch_assembly_frames.ts'),
  join(ops, 'generate_emberwatch_house_frames.ts'),
