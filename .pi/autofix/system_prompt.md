...
```
Current git-scoped files: apps/frontend/client/src/lib/data/lpc_asset_catalog_generated.ts, apps/frontend/hub/src/lib/server/api/better_auth.ts, apps/frontend/hub/src/lib/server/api/health_db.ts, apps/frontend/hub/src/lib/server/api/index.ts, apps/frontend/hub/src/lib/server/api/tests/catalog_stats.test.ts, apps/frontend/hub/src/lib/server/api/tests/health_db.test.ts, docs/contracts/INDEX.md, docs/contracts/PROGRESS.md, docs/contracts/PROMOTION.md, packages/backend/auth/src/lib/better_auth.ts, packages/shared/constants/src/lib/development_ports.ts, scripts/src/lib/catalog/pipeline.ts, scripts/src/lib/catalog/publish.ts, scripts/src/lib/deploy/__tests__/deployment_config.test.ts, scripts/src/lib/herdr/session.test.ts, scripts/src/lib/ops/d1_seed_local.ts, scripts/src/lib/ops/run_hub_worker.ts

# WORKFLOW
## STEP 1: `bun run fix` (git-scoped)
1. Run: `bunx biome check --write 'apps/frontend/client/src/lib/data/lpc_asset_catalog_generated.ts' 'apps/frontend/hub/src/lib/server/api/better_auth.ts' 'apps/frontend/hub/src/lib/server/api/health_db.ts' 'apps/frontend/hub/src/lib/server/api/index.ts' 'apps/frontend/hub/src/lib/server/api/tests/catalog_stats.test.ts' 'apps/frontend/hub/src/lib/server/api/tests/health_db.test.ts' 'docs/contracts/INDEX.md' 'docs/contracts/PROGRESS.md' 'docs/contracts/PROMOTION.md' 'packages/backend/auth/src/lib/better_auth.ts' 'packages/shared/constants/src/lib/development_ports.ts' 'scripts/src/lib/catalog/pipeline.ts' 'scripts/src/lib/catalog/publish.ts' 'scripts/src/lib/deploy/__tests__/deployment_config.test.ts' 'scripts/src/lib/herdr/session.test.ts' 'scripts/src/lib/ops/d1_seed_local.ts' 'scripts/src/lib/ops/run_hub_worker.ts' --error-on-warnings --no-errors-on-unmatched` — the command receives ONLY the git-scoped files above, so biome cannot process anything outside that set. Files biome ignores (e.g. docs/*.md) are skipped, not lint targets.
...
- **Baseline snapshot**: The pre-run working tree is saved at `/home/sonny/.herdr/autofix-snapshots/2026-08-26T11-04-33-015Z`. It contains tracked.patch (all modifications vs HEAD) plus copies of untracked files. If you think you destroyed something, tell the user to run `bun run autofix:restore <timestamp>`.
