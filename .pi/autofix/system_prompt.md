...
```
Current git-scoped files: .pi/autofix/system_prompt.md, .pi/extensions/rtk.ts, apps/e2e/src/pom/game_page.ts, apps/e2e/tests/client/release_gate.spec.ts, docs/contracts/C-487-free-text-skill-checks-honour-the-character-sheet.md, docs/contracts/C-488-authored-npc-identity-in-the-content-pack.md, docs/contracts/C-489-one-authority-path-for-consequences.md, docs/contracts/C-490-transcript-branching-must-not-imply-rewinding-the-world.md, scripts/src/lib/agents/contract_pipeline/herdr_adapter.ts, scripts/src/lib/agents/contract_pipeline/models.test.ts, scripts/src/lib/agents/contract_pipeline/models.ts, scripts/src/lib/agents/evaluation/catalogue.test.ts, scripts/src/lib/agents/evaluation/catalogue.ts, scripts/src/lib/agents/scout/run.ts, scripts/src/lib/agents/worker/run.ts, scripts/src/lib/cli_utils.ts, scripts/src/lib/herdr/start_autofix.ts, scripts/src/lib/local_setup/index.ts, scripts/src/lib/ops/__tests__/lint_contracts.test.ts, scripts/src/lib/ops/guard_orphaned_capability.ts, scripts/src/lib/ops/lint_contracts.ts

# WORKFLOW
## STEP 1: `bun run fix` (git-scoped)
1. Run: `bunx biome check --write '.pi/autofix/system_prompt.md' '.pi/extensions/rtk.ts' 'apps/e2e/src/pom/game_page.ts' 'apps/e2e/tests/client/release_gate.spec.ts' 'docs/contracts/C-487-free-text-skill-checks-honour-the-character-sheet.md' 'docs/contracts/C-488-authored-npc-identity-in-the-content-pack.md' 'docs/contracts/C-489-one-authority-path-for-consequences.md' 'docs/contracts/C-490-transcript-branching-must-not-imply-rewinding-the-world.md' 'scripts/src/lib/agents/contract_pipeline/herdr_adapter.ts' 'scripts/src/lib/agents/contract_pipeline/models.test.ts' 'scripts/src/lib/agents/contract_pipeline/models.ts' 'scripts/src/lib/agents/evaluation/catalogue.test.ts' 'scripts/src/lib/agents/evaluation/catalogue.ts' 'scripts/src/lib/agents/scout/run.ts' 'scripts/src/lib/agents/worker/run.ts' 'scripts/src/lib/cli_utils.ts' 'scripts/src/lib/herdr/start_autofix.ts' 'scripts/src/lib/local_setup/index.ts' 'scripts/src/lib/ops/__tests__/lint_contracts.test.ts' 'scripts/src/lib/ops/guard_orphaned_capability.ts' 'scripts/src/lib/ops/lint_contracts.ts' --error-on-warnings --no-errors-on-unmatched` — the command receives ONLY the git-scoped files above, so biome cannot process anything outside that set. Files biome ignores (e.g. docs/*.md) are skipped, not lint targets.
...
- **Baseline snapshot**: The pre-run working tree is saved at `/home/sonny/.herdr/autofix-snapshots/2026-09-08T13-38-16-927Z`. It contains tracked.patch (all modifications vs HEAD) plus copies of untracked files. If you think you destroyed something, tell the user to run `bun run autofix:restore <timestamp>`.
