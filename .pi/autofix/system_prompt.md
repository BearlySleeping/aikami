...
```
Current git-scoped files: .pi/.secrets_fixture/production_hashes.txt, .pi/autofix/system_prompt.md, .pi/bun.lock, .pi/extensions/bash_timeout_normalizer.ts, .pi/package.json, .pi/scripts/update_skills.ts, .pi/settings.json, apps/backend/worker/package.json, apps/e2e/package.json, apps/frontend/client/package.json, apps/frontend/client/scripts/check_bundle.ts, apps/frontend/client/src/lib/components/game/lpc_character_renderer.svelte, apps/frontend/client/src/lib/components/game/lpc_context_keys.ts, apps/frontend/client/src/lib/data/lpc_icon_frame.ts, apps/frontend/client/src/lib/data/lpc_renderer.test.ts, apps/frontend/client/src/lib/data/lpc_renderer.ts, apps/frontend/client/src/lib/data/lpc_url_config.ts, apps/frontend/client/src/lib/services/assets/registry_asset_resolver.ts, apps/frontend/client/src/lib/test_preload.ts, apps/frontend/client/src/routes/(dev)/dev/(sandbox)/sandbox/map/+page.svelte, apps/frontend/client/src/routes/(dev)/dev/lpc-walk/+page.svelte, apps/frontend/client/src/routes/(dev)/dev/lpc/+page.svelte, apps/frontend/client/vite.config.ts, apps/frontend/docs/astro.config.ts, apps/frontend/docs/package.json, apps/frontend/docs/tsconfig.json, apps/frontend/hub/package.json, apps/frontend/hub/src/app.html, apps/frontend/hub/src/lib/test_preload.ts, apps/frontend/hub/src/lib/views/catalog/catalog_asset_view_model.svelte.ts, apps/frontend/hub/src/lib/views/sandbox/walk_sandbox_view.svelte, apps/frontend/hub/vite.config.ts, apps/frontend/site/astro.config.ts, apps/frontend/site/package.json, apps/frontend/site/tsconfig.json, biome.json, bun.lock, config/tsconfig/tsconfig.paths.shared.json, docs/TODO.md, package.json, packages/backend/auth/package.json, packages/backend/chat/package.json, packages/backend/discord-bot/package.json, packages/frontend/configs/package.json, packages/frontend/configs/tsconfig.json, packages/frontend/engine/package.json, packages/frontend/engine/src/__tests__/equipment_merge.test.ts, packages/frontend/engine/src/index.ts, packages/frontend/engine/src/pixi_app.ts, packages/frontend/engine/src/rendering/texture_defaults.ts, packages/frontend/engine/tsconfig.json, packages/frontend/preview/package.json, packages/frontend/preview/src/lib/lpc/lpc_preview_view_model.svelte.ts, packages/frontend/preview/src/lib/lpc/lpc_renderer.ts, packages/frontend/preview/src/lib/sandbox/walk_sandbox.svelte, packages/frontend/preview/src/lib/sandbox/walk_sandbox_view_model.svelte.ts, packages/frontend/preview/tsconfig.json, packages/frontend/services/tsconfig.json, packages/frontend/storage/tsconfig.json, packages/frontend/theme/package.json, packages/frontend/utils/package.json, packages/shared/constants/src/lib/equipment.ts, packages/shared/logger/package.json, packages/shared/mocks/package.json, packages/shared/schemas/package.json, packages/shared/types/package.json, scripts/package.json, scripts/src/lib/herdr/session.ts, scripts/src/lib/herdr/worktree.ts, scripts/src/lib/local_setup/index.ts, scripts/src/lib/ops/pin_dependencies.ts

# WORKFLOW
## STEP 1: `bun run fix` (git-scoped)
1. Run: `bunx biome check --write '.pi/.secrets_fixture/production_hashes.txt' '.pi/autofix/system_prompt.md' '.pi/bun.lock' '.pi/extensions/bash_timeout_normalizer.ts' '.pi/package.json' '.pi/scripts/update_skills.ts' '.pi/settings.json' 'apps/backend/worker/package.json' 'apps/e2e/package.json' 'apps/frontend/client/package.json' 'apps/frontend/client/scripts/check_bundle.ts' 'apps/frontend/client/src/lib/components/game/lpc_character_renderer.svelte' 'apps/frontend/client/src/lib/components/game/lpc_context_keys.ts' 'apps/frontend/client/src/lib/data/lpc_icon_frame.ts' 'apps/frontend/client/src/lib/data/lpc_renderer.test.ts' 'apps/frontend/client/src/lib/data/lpc_renderer.ts' 'apps/frontend/client/src/lib/data/lpc_url_config.ts' 'apps/frontend/client/src/lib/services/assets/registry_asset_resolver.ts' 'apps/frontend/client/src/lib/test_preload.ts' 'apps/frontend/client/src/routes/(dev)/dev/(sandbox)/sandbox/map/+page.svelte' 'apps/frontend/client/src/routes/(dev)/dev/lpc-walk/+page.svelte' 'apps/frontend/client/src/routes/(dev)/dev/lpc/+page.svelte' 'apps/frontend/client/vite.config.ts' 'apps/frontend/docs/astro.config.ts' 'apps/frontend/docs/package.json' 'apps/frontend/docs/tsconfig.json' 'apps/frontend/hub/package.json' 'apps/frontend/hub/src/app.html' 'apps/frontend/hub/src/lib/test_preload.ts' 'apps/frontend/hub/src/lib/views/catalog/catalog_asset_view_model.svelte.ts' 'apps/frontend/hub/src/lib/views/sandbox/walk_sandbox_view.svelte' 'apps/frontend/hub/vite.config.ts' 'apps/frontend/site/astro.config.ts' 'apps/frontend/site/package.json' 'apps/frontend/site/tsconfig.json' 'biome.json' 'bun.lock' 'config/tsconfig/tsconfig.paths.shared.json' 'docs/TODO.md' 'package.json' 'packages/backend/auth/package.json' 'packages/backend/chat/package.json' 'packages/backend/discord-bot/package.json' 'packages/frontend/configs/package.json' 'packages/frontend/configs/tsconfig.json' 'packages/frontend/engine/package.json' 'packages/frontend/engine/src/__tests__/equipment_merge.test.ts' 'packages/frontend/engine/src/index.ts' 'packages/frontend/engine/src/pixi_app.ts' 'packages/frontend/engine/src/rendering/texture_defaults.ts' 'packages/frontend/engine/tsconfig.json' 'packages/frontend/preview/package.json' 'packages/frontend/preview/src/lib/lpc/lpc_preview_view_model.svelte.ts' 'packages/frontend/preview/src/lib/lpc/lpc_renderer.ts' 'packages/frontend/preview/src/lib/sandbox/walk_sandbox.svelte' 'packages/frontend/preview/src/lib/sandbox/walk_sandbox_view_model.svelte.ts' 'packages/frontend/preview/tsconfig.json' 'packages/frontend/services/tsconfig.json' 'packages/frontend/storage/tsconfig.json' 'packages/frontend/theme/package.json' 'packages/frontend/utils/package.json' 'packages/shared/constants/src/lib/equipment.ts' 'packages/shared/logger/package.json' 'packages/shared/mocks/package.json' 'packages/shared/schemas/package.json' 'packages/shared/types/package.json' 'scripts/package.json' 'scripts/src/lib/herdr/session.ts' 'scripts/src/lib/herdr/worktree.ts' 'scripts/src/lib/local_setup/index.ts' 'scripts/src/lib/ops/pin_dependencies.ts' --error-on-warnings --no-errors-on-unmatched` — the command receives ONLY the git-scoped files above, so biome cannot process anything outside that set. Files biome ignores (e.g. docs/*.md) are skipped, not lint targets.
...
- **Baseline snapshot**: The pre-run working tree is saved at `C:\Users\snorr\.herdr\autofix-snapshots\2026-08-29T18-20-48-260Z`. It contains tracked.patch (all modifications vs HEAD) plus copies of untracked files. If you think you destroyed something, tell the user to run `bun run autofix:restore <timestamp>`.
