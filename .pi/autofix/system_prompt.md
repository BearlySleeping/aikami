...
```
Current git-scoped files: apps/e2e/src/pom/catalog_preview_page.ts, apps/e2e/src/pom/index.ts, apps/e2e/src/visual/suites/hub_lpc_preview.visual.ts, apps/e2e/src/visual/suites/hub_tileset_preview.visual.ts, apps/frontend/client/src/lib/components/game/lpc_item_icon.svelte, apps/frontend/client/src/lib/data/lpc_asset_catalog.ts, apps/frontend/client/src/lib/data/lpc_icon_frame.ts, apps/frontend/client/src/lib/data/lpc_renderer.ts, apps/frontend/client/src/lib/data/lpc_url_config.ts, apps/frontend/client/src/lib/services/api/hub_api_client.ts, apps/frontend/client/src/lib/services/auth/auth_service.svelte.ts, apps/frontend/client/src/lib/test_preload.ts, apps/frontend/client/src/routes/(dev)/dev/(sandbox)/sandbox/map/+page.svelte, apps/frontend/client/src/routes/(dev)/dev/lpc-walk/+page.svelte, apps/frontend/client/src/routes/(dev)/dev/lpc-walk/lpc_walk_view_model.svelte.ts, apps/frontend/client/src/routes/(dev)/dev/lpc/+page.svelte, apps/frontend/hub/src/lib/__tests__/server_bundle_purity.test.ts, apps/frontend/hub/src/lib/views/catalog/catalog_asset_view_model.svelte.ts, apps/frontend/hub/src/lib/views/catalog/components/catalog_asset_tile.svelte, packages/frontend/engine/src/game_world.ts, packages/frontend/preview/src/index.ts, packages/frontend/preview/src/lib/__tests__/host_agnostic.test.ts, packages/frontend/preview/src/lib/lpc/lpc_icon_frame.ts, packages/frontend/preview/src/lib/lpc/lpc_preview.svelte, packages/frontend/preview/src/lib/lpc/lpc_preview_view_model.svelte.ts, packages/frontend/preview/src/lib/lpc/lpc_renderer.ts, packages/frontend/preview/src/lib/lpc/preview_url_state.ts, packages/frontend/preview/src/lib/map/map_preview.svelte, packages/frontend/preview/src/lib/prop/prop_preview.svelte, packages/frontend/preview/src/lib/sandbox/walk_sandbox.svelte, packages/frontend/preview/src/lib/sandbox/walk_sandbox_view_model.svelte.ts, packages/frontend/preview/src/lib/tileset/tileset_preview.svelte, packages/frontend/preview/tsconfig.json

# WORKFLOW
## STEP 1: `bun run fix` (git-scoped)
1. Run: `bunx biome check --write 'apps/e2e/src/pom/catalog_preview_page.ts' 'apps/e2e/src/pom/index.ts' 'apps/e2e/src/visual/suites/hub_lpc_preview.visual.ts' 'apps/e2e/src/visual/suites/hub_tileset_preview.visual.ts' 'apps/frontend/client/src/lib/components/game/lpc_item_icon.svelte' 'apps/frontend/client/src/lib/data/lpc_asset_catalog.ts' 'apps/frontend/client/src/lib/data/lpc_icon_frame.ts' 'apps/frontend/client/src/lib/data/lpc_renderer.ts' 'apps/frontend/client/src/lib/data/lpc_url_config.ts' 'apps/frontend/client/src/lib/services/api/hub_api_client.ts' 'apps/frontend/client/src/lib/services/auth/auth_service.svelte.ts' 'apps/frontend/client/src/lib/test_preload.ts' 'apps/frontend/client/src/routes/(dev)/dev/(sandbox)/sandbox/map/+page.svelte' 'apps/frontend/client/src/routes/(dev)/dev/lpc-walk/+page.svelte' 'apps/frontend/client/src/routes/(dev)/dev/lpc-walk/lpc_walk_view_model.svelte.ts' 'apps/frontend/client/src/routes/(dev)/dev/lpc/+page.svelte' 'apps/frontend/hub/src/lib/__tests__/server_bundle_purity.test.ts' 'apps/frontend/hub/src/lib/views/catalog/catalog_asset_view_model.svelte.ts' 'apps/frontend/hub/src/lib/views/catalog/components/catalog_asset_tile.svelte' 'packages/frontend/engine/src/game_world.ts' 'packages/frontend/preview/src/index.ts' 'packages/frontend/preview/src/lib/__tests__/host_agnostic.test.ts' 'packages/frontend/preview/src/lib/lpc/lpc_icon_frame.ts' 'packages/frontend/preview/src/lib/lpc/lpc_preview.svelte' 'packages/frontend/preview/src/lib/lpc/lpc_preview_view_model.svelte.ts' 'packages/frontend/preview/src/lib/lpc/lpc_renderer.ts' 'packages/frontend/preview/src/lib/lpc/preview_url_state.ts' 'packages/frontend/preview/src/lib/map/map_preview.svelte' 'packages/frontend/preview/src/lib/prop/prop_preview.svelte' 'packages/frontend/preview/src/lib/sandbox/walk_sandbox.svelte' 'packages/frontend/preview/src/lib/sandbox/walk_sandbox_view_model.svelte.ts' 'packages/frontend/preview/src/lib/tileset/tileset_preview.svelte' 'packages/frontend/preview/tsconfig.json' --error-on-warnings --no-errors-on-unmatched` — the command receives ONLY the git-scoped files above, so biome cannot process anything outside that set. Files biome ignores (e.g. docs/*.md) are skipped, not lint targets.
...
- **Baseline snapshot**: The pre-run working tree is saved at `/home/sonny/.herdr/autofix-snapshots/2026-08-27T12-13-47-471Z`. It contains tracked.patch (all modifications vs HEAD) plus copies of untracked files. If you think you destroyed something, tell the user to run `bun run autofix:restore <timestamp>`.
