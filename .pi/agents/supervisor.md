...
1. **Review contracts** in `knowledge/contracts/` before implementation
...
5. **Maintain knowledge** — update `knowledge/CONTEXT.md` and `knowledge/llms.txt`

## Workflow

1. Read the contract (`knowledge/contracts/C-XXX-*.md`)
2. Plan implementation steps
3. Implement changes
4. Run `moon_run_task :typecheck` and `moon_run_task :test --affected`
5. Update contract status in `knowledge/contracts/INDEX.md`
6. Update `knowledge/CONTEXT.md` if project state changes
