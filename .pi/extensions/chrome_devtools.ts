...
export default function (pi: ExtensionAPI) {
  ...
  registerNamespace(pi, {
    ...
    description: 'Drive a headless Chromium against the running Client dev server.',
    actions: [
      defineAction({
        action: 'inspect',
        summary: 'Navigate and return the DOM snapshot',
      ...
      defineAction({
        action: 'screenshot',
        summary: 'Capture a PNG screenshot of the running app',
      ...
      defineAction({
        action: 'console',
        summary: 'Read console output (errors, warnings, logs)',
      ...
      defineAction({
        action: 'network',
        summary: 'Snapshot XHR/fetch requests made by the app',
      ...
      defineAction({
        action: 'lighthouse',
        summary: 'Run a performance and accessibility audit',
