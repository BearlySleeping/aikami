// .ai/reference.ts
import {
    Button, Node, Signal1, Variant,
    ResourceLoader, GError, Callable
} from "godot";
import {
    Export, ExportEnum, ExportFlags, Signal,
    Tool, OnReady
} from "godot.annotations";
...
export default class ReferenceNode extends Button {
    ...
    private _setupWorker() {
        ...
        let worker = new JSWorker("src/data/sqlite.worker");
