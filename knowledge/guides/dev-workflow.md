...
1. **Write a contract** in `knowledge/contracts/` using the [TEMPLATE](contracts/TEMPLATE.md)
...
4. **Update knowledge** — run `bun run knowledge:generate`
...
bun run scripts -- generate_llms    # Regenerate knowledge/llms.txt
