...
description: Best practices, syntax rules, and examples for writing TypeScript/JavaScript scripts in Godot using the Godot.js framework. Use when writing, refactoring, or debugging TypeScript/JavaScript code for Godot games.
---
