...
### All Library Projects (packages/shared/*, packages/backend/*, packages/frontend/*)
...
### App Projects (apps/frontend/*, apps/backend/*)
...
**Test Hooks**:
- Unit: Each package.json has `"typecheck": "tsc --noEmit"` or equivalent
