...
| **Target** | `capability_service.svelte.ts`, `config_service.svelte.ts`, — TBD |
| **Priority** | P0 — C-320 defines the gateway; this contract makes it the — Phase 1 — Playable, Polished, Offline-Capable Vertical Slice |
...
- **Current behavior**: Wire the AI Provider Gateway into Capability Detection and Settings — see TODO.md for details.
...
exactly one piece of code pings/tracks local and cloud provider
