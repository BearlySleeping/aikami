...
| **Target** | pure shared rules package, command/event schemas, seedable RNG, and — TBD |
| **Priority** | P1 — shared mechanics need one authoritative, replayable owner. — Phase 2 — Core RPG Depth and Replayability |
...
- **Current behavior**: Extract a Deterministic Rules Kernel and Typed Game Command Protocol — see TODO.md for details.
...
movement-adjacent actions, checks, combat, items, quests, rewards,
