...
github:
    ...
    pr_url: "https://github.com/BearlySleeping/aikami/pull/282"
    pr_number: 282
...
```ts
type SlashCommandResult = { kind: "generate"; prompt: string } | { kind: "tree" } | { kind: "gm"; text: string } | { kind: "help" } | { kind: "none" }; // not a slash command — forward as normal dialogue
```
...
- **Out of Scope:**
    ...
    - New dialogue command _kinds_ in the schema union.
