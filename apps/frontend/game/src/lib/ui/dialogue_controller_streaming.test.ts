// apps/frontend/game/src/lib/ui/dialogue_controller_streaming.test.ts

import { afterAll, beforeAll, beforeEach, describe, expect, mock, test } from 'bun:test';
import type {
  DialogueGeneratorInterface,
  DialogueGeneratorOptions,
} from '$lib/systems/interaction_bridge.ts';
...
const createMockFunctions = () =>
  ...
  }) as unknown as import('$lib/services/firebase/functions.ts').FirebaseFunctionsInterface;
