...
// copy of the routes directory (`.svelte-kit/routes-prod`) generated by
// scripts/gate_dev_routes.ts whenever dev routes must be excluded. The flag
// is a build flag, never a runtime check:
//
//   AIKAMI_INCLUDE_DEV_ROUTES=true   → always include `(dev)` (test builds)
//   AIKAMI_INCLUDE_DEV_ROUTES=false  → always exclude `(dev)`
//   unset                            → include unless AIKAMI_BUILD_MODE is
...
const routesDir = includeDevRoutes ? 'src/routes' : '.svelte-kit/routes-prod';
