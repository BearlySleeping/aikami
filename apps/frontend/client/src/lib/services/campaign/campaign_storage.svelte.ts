// apps/frontend/client/src/lib/services/campaign/campaign_storage.svelte.ts
//
...
export type CampaignStorageInterface = BaseFrontendClassInterface & {
...
class CampaignStorage
  ...
  implements CampaignStorageInterface
{
  /** @inheritdoc */
...
export const campaignStorage: CampaignStorageInterface = CampaignStorage.create({
  className: 'CampaignStorage',
});
