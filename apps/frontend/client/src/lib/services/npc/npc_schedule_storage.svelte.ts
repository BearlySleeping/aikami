// apps/frontend/client/src/lib/services/npc/npc_schedule_storage.svelte.ts
//
...
export type NpcScheduleStorageInterface = BaseFrontendClassInterface & {
...
class NpcScheduleStorage
  extends BaseFrontendClass<BaseFrontendClassOptions>
  implements NpcScheduleStorageInterface
{
  /** @inheritdoc */
...
export const npcScheduleStorage: NpcScheduleStorageInterface = NpcScheduleStorage.create({
  className: 'NpcScheduleStorage',
});
