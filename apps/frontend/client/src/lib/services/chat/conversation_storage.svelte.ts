// apps/frontend/client/src/lib/services/chat/conversation_storage.svelte.ts
//
 ...
 * database layer.
 */
export type ConversationStorageInterface = {
  /**
 ...
 */
class TursoConversationStorage implements ConversationStorageInterface {
  /** @inheritdoc */
