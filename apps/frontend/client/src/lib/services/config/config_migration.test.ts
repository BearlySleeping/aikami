  ...
  describe('Basic migration', () => {
    ...
    test('migrates v2 with connections to v3', () => {
      const v2: VaultPayloadV2 = {
        schemaVersion: 2,
        providers: [
          { id: 'prov-1', registryId: 'openrouter', label: 'OR', source: 'stored', credential: 'sk-key' },
        ],
        connections: [
          {
            id: 'conn-1', providerId: 'prov-1', capability: 'text', label: 'Claude',
            model: 'anthropic/claude-opus-4',
            params: { temperature: 0.7, topP: 0.9, topK: 40, repetitionPenalty: 1.1, presencePenalty: 0, maxTokens: 1024, contextSize: 4096 },
    ...
    test('creates overrides for roles that differ from defaults', () => {
      const v2: VaultPayloadV2 = {
        ...
        connections: [
          ...
          {
            id: 'conn-2', providerId: 'prov-1', capability: 'text', label: 'GPT',
            model: 'openai/gpt-4o',
            params: { temperature: 0.7, topP: 0.9, topK: 40, repetitionPenalty: 1.1, presencePenalty: 0, maxTokens: 1024, contextSize: 4096 },
            createdAt: '2026-01-01T00:00:00.000Z', updatedAt: '2026-01-01T00:00:00.000Z',
          },
