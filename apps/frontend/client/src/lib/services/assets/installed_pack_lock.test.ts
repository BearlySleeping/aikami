  ...
  bindings: [
    {
      ...
      target: 'music',
      context: 'village',
      source: { kind: 'asset', tag: 'music:exploration:bgm_explore', sha256: HASH_EXPLORE },
      resolution: 'required',
      fallback: 'silence',
    },
    {
      ...
      target: 'music',
      context: 'combat',
      source: { kind: 'asset', tag: 'music:combat:bgm_combat', sha256: HASH_COMBAT },
      resolution: 'required',
      fallback: 'silence',
    },
    {
      ...
      target: 'music',
      context: 'inn',
      source: { kind: 'asset', tag: 'music:exploration:Chainsmoker', sha256: HASH_OTHER },
      resolution: 'optional',
