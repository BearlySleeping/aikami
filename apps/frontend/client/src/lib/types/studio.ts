...
// interface, the view-model interface and the display rows describe *data*
// shapes, not behaviour, so they belong with the rest of the app-local types
// rather than inside the unit that owns the studio's behaviour.
//
// Contract: C-512 Creator Studio and Runtime Asset Generation, C-513

import type { GenerationEngineId, LibraryEntry, StudioRecipeOption } from '@aikami/types';
