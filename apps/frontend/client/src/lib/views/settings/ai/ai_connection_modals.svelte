...
<!-- ═══════════════════════════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════════════════════════ -->
<Modal bind:open={viewModel.isEditorOpen} size="lg" onclose={() => viewModel.cancelEdit()}>
  {#snippet title()}
  ...
  <div class="space-y-4">
    <!-- Provider dropdown -->
    <div>
      <label for="provider-select" class="label-text font-mono text-xs mb-1 block">Provider</label>
      <select
        id="provider-select"
...
{#if viewModel.keyConflictPrompt}
  ...
  <Modal open={true} size="md" onclose={() => viewModel.dismissKeyConflict()}>
    {#snippet title()}
