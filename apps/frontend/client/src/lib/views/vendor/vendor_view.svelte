...
<BaseViewModelContainer {viewModel}>
  ...
  >
    ...
    >
            ...
            {#if viewModel.refusesToSell}
              <div class="alert alert-error mt-2">
                ...
                <span class="text-sm font-semibold"
                  >The vendor refuses to do business with you.</span
                >
              </div>
            {/if}
          </div>
      ...
      <div
        class="flex flex-col {viewModel.isHagglePanelCollapsed ? 'flex-1' : 'w-2/5'} bg-base-100"
      >
        <!-- Gold display -->
        <div
        ...
        <div class="flex-1 overflow-y-auto px-3 pb-3">
          {#if viewModel.items.length === 0}
            <div
              class="flex flex-col items-center justify-center h-full text-base-content/40 gap-2"
            >
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      <div class="flex items-center gap-1 mt-0.5">
                        <span
                          class="text-xs font-bold {priceColorClass(isDiscounted, isPenalized)}"
                        >
                          🪙 {finalPrice}
                        </span>
                        {#if isDiscounted}
