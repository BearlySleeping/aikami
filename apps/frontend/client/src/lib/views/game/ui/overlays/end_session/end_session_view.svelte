    ...
    <div class="w-96 rounded-xl border border-base-300 bg-base-200 p-6 shadow-xl">
      ...
      {#if viewModel.phase === 'confirm'}
        ...
        <p class="mt-4 text-sm text-base-content/70">
          This will lock the chat, generate a summary of your session, and save your progress. You
          can start a new session afterward.
        </p>
      ...
      {:else if viewModel.phase === 'preview'}
        ...
        <div
          class="mt-4 rounded-lg bg-base-100 p-4 max-h-64 overflow-y-auto border border-base-300"
        >
