// apps/frontend/client/src/lib/game/ui/dialogue_controller.ts
...
import type { FirebaseFunctionsInterface } from '$lib/game/services/firebase/functions.ts';
import type { DialogueGeneratorInterface } from '$lib/game/systems/interaction_bridge.ts';
import type { InteractableNpcEntry } from '$lib/game/systems/interaction_system.ts';
import { endInteraction } from '$lib/game/systems/interaction_system.ts';
