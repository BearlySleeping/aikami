// biome-ignore-all lint/style/useNamingConvention: Open Graph meta tag properties
// apps/frontend/hub/src/lib/views/app/metadata/head-tags-view-model.svelte.ts
import {
  BaseViewModel,
