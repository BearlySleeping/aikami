// apps/frontend/hub/src/lib/views/app/error/app_error_view_model.svelte.ts
import {
  BaseViewModel,
...
export type AppErrorViewModelInterface = BaseViewModelInterface & {
  ...
  readonly metadata: ErrorMetaTags;
  ...
  implements AppErrorViewModelInterface
{
  ...
  private _getMetadata(): ErrorMetaTags {
...
export const getAppErrorViewModel = (options: AppErrorViewModelOptions) =>
  AppErrorViewModel.create({ ...options, className: 'AppErrorViewModel' });
