...
export type MessageServiceInterface = BaseFrontendClassInterface & {
   ...
   */
  getMessages(uid: string, characterId: string): Promise<MessageData[]>;
...
export class MessageService
  extends BaseFrontendClass<MessageServiceOptions>
  implements MessageServiceInterface
{
  ...
  async getMessages(uid: string, characterId: string): Promise<MessageData[]> {
