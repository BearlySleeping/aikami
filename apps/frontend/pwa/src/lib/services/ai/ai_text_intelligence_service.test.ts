// apps/frontend/pwa/src/lib/services/media/ai_text_intelligence_service.test.ts
//
// Unit tests for AiTextIntelligenceService (C-080).
//
// Run with:
//   bun test --preload ./src/lib/test_preload.ts --tsconfig tsconfig.test.json \
//     src/lib/services/media/ai_text_intelligence_service.test.ts
...
const CRYPTO_VAULT_PATH =
  '/home/sonny/Development/Projects/passion/aikami/apps/frontend/pwa/src/lib/utils/crypto_vault.ts';
