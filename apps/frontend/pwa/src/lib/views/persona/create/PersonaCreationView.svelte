<script lang="ts">
  // apps/frontend/pwa/src/lib/views/persona/create/PersonaCreationView.svelte
  import t from '$i18n';
    ...
    <div class="card w-full max-w-md bg-base-100 shadow-xl">
      <div class="card-body">
        ...
        <div class="form-control">
          <label class="label" for="avatar-upload"> <span class="label-text">Avatar</span> </label>
          <input
            type="file"
            id="avatar-upload"
            accept="image/*"
        ...
        {#if viewModel.generatedPersona}
          <div class="mt-4">
            <h3 class="text-lg font-bold">{viewModel.generatedPersona.name}</h3>
