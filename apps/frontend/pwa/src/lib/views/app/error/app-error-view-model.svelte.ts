...
import type { BaseMetaTags } from '../metadata/head-tags-view-model.svelte'
...
class AppErrorViewModel extends BaseViewModel<AppErrorViewModelOptions>
  ...
  > = {
    'page-not-found': {
      ...
      icon:
        'M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0112 15c-2.34 0-4.29-1.445-5.103-3.5',
    },
    'access-denied': {
