<script lang="ts">
    import { getAppErrorViewModel } from "./app-error-view-model.svelte";
    ...
    <div class="hero-content text-center">
        <div class="max-w-md">
            ...
            <p class="py-6 text-base-content/70">
                {viewModel.currentError.description}
            </p>
