...
export type SettingsViewModelInterface = BaseViewModelInterface & {
   ...
   */
  readonly preferencesErrors: Partial<
    Record<keyof z.infer<typeof PreferencesFormSchema>, string>
  >
...
class SettingsViewModel extends BaseViewModel<SettingsViewModelOptions>
