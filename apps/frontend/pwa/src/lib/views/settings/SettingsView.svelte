...
<BaseViewModelContainer {viewModel} class="container mx-auto p-6 max-w-4xl">
                ...
                >
                    <div class="form-control">
                        ...
                        <input
                            ...
                            class:input-error={viewModel.profileErrors
                                .displayName}
                ...
                >
                    <div class="form-control">
                        ...
                        <select
                            ...
                            class:select-error={viewModel.preferencesErrors
                                .theme}
                    ...
                    <div class="form-control">
                        <label class="label cursor-pointer">
                            ...
                            <input
                                ...
                                checked={viewModel.preferencesForm
                                    .notifications}
                                onchange={(e) =>
                                    viewModel.updatePreferencesField(
                                        "notifications",
    ...
    <div class="card bg-base-100 shadow-xl mt-8">
        <div class="card-body">
            <h2 class="card-title text-xl text-error mb-4">
                {t.danger_zone()}
            </h2>
