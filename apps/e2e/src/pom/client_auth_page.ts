// apps/e2e/src/pom/client_auth_page.ts
// Page Object Model — ClientAuthPage
//
...
//   apps/frontend/client/src/lib/views/auth/register/register_view.svelte
//   apps/frontend/client/src/lib/paraglide/messages/en.js
