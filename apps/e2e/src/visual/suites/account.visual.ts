...
const AccountSchema = Type.Object({
	...
	hasSignInButtons: Type.Boolean({ description: 'Whether Google and email sign-in buttons are visible' }),
	hasOfflineMessage: Type.Boolean({ description: 'Whether the offline/device-local message is shown' }),
	hasNoDeleteControls: Type.Boolean({ description: 'Whether no sync or delete controls are visible when signed out' }),
