...
func fill_rect(rect: Rect2i, value: Variant) -> void:
	assert(value, "Can't fill with null!")
	_fill_rect_unsafe(rect, value)


func _fill_rect_unsafe(rect: Rect2i, value: Variant) -> void:
