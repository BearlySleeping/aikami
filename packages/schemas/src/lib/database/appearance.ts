...
export const AppearanceSchema = z.object({
  avatarUrl: z.string().url().describe('URL to the character avatar image').optional(),
  portraitUrl: z.string().url().describe('URL to the character portrait').optional(),
  physicalDescription: z.string().describe('Physical description of the character').optional(),
