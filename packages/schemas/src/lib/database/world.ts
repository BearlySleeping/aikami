...
export const WorldLocationSchema = z.object({
  ...
  connections: z.string().array().describe('IDs of connected locations').default([]),
...
export const WorldEventSchema = z.object({
  ...
  participantIds: z.string().array().describe('Character IDs involved').default([]),
...
export const WorldStateSchema = z.object({
  ...
  variables: z.record(z.string(), z.unknown()).describe('Custom world variables').default({}),
