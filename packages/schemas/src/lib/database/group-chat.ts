...
export const GroupChatCreateSchema = GroupChatSchema.omit(CoreOmitSchema).extend(
  CoreCreateSchema.shape,
);

export const GroupChatUpdateSchema = GroupChatSchema.extend(getDeletableFields(GroupChatSchema))
  .omit(CoreOmitSchema)
