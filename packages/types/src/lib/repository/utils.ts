...
export type GetBasePathArguments = Record<string, string | number> | void

type GetCollectionQueryOptions<
  T extends CoreData,
  Argument extends GetBasePathArguments,
> = {
...
export type GetQueryOptions<
  T extends CoreData,
  Argument extends GetBasePathArguments,
> = GetCollectionQueryOptions<T, Argument> | GetCollectionNameQueryOptions<T>

export type GetPathFunction<Argument extends GetBasePathArguments> = (
  argument: Argument,
) => string
...
export type RepositoryType<
  Data extends ZodType<z.infer<typeof CoreSchema>> = ZodType<
    z.infer<typeof CoreSchema>
  >,
