...
export abstract class BaseRepository<
  T extends RepositoryType,
> extends BaseClass {
  protected readonly getCollectionPath: GetPathFunction<
    T['getCollectionPathArgument']
  >
  protected readonly getDocumentPath: GetPathFunction<
    T['getDocumentPathArgument']
  >
  ...
  protected async parseDocuments(
  ...
  protected async parse(
  ...
  ): Promise<any> { // Implementation's async nature wraps the returned value in Promise<any>
    ...
    switch (type) {
      ...
      default: { // Already had braces, no change to content needed, just ensuring it's the target
