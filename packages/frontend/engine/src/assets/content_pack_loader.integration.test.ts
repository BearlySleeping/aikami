...
const emberwatchManifest = {
  ...
  npcs: {
    ...
    traveling_merchant: {
      ...
      appearanceLayers: [3, 91, 127, 22, 19, 95],
      isVendor: true,
    ...
    elara_wayfinder: {
      ...
      appearanceLayers: [2, 91, 22, 21, 20, 94],
      isVendor: false,
    },
    // biome-ignore lint/style/useNamingConvention: JSON manifest key
    kade_blackthorn: {
    ...
    shrine_spirit: {
      ...
      appearanceLayers: [2, 3, 65, 21, 20, 96],
      isVendor: false,
    },
    // biome-ignore lint/style/useNamingConvention: JSON manifest key
    shade_guardian: {
  ...
  factions: {
    ...
    town_guard: {
      ...
      name: 'Town Guard',
      description:
        'The protectors of Emberwatch village. Stoic, disciplined, and loyal to the elder council.',
      defaultStanding: 0,
      standingTiers: [
        { threshold: -100, tier: 'hostile', label: 'Hostile' },
        { threshold: -60, tier: 'unfriendly', label: 'Unfriendly' },
        { threshold: -20, tier: 'neutral', label: 'Neutral' },
        { threshold: 20, tier: 'friendly', label: 'Friendly' },
        { threshold: 60, tier: 'honored', label: 'Honored' },
      ],
    },
    // biome-ignore lint/style/useNamingConvention: JSON manifest key
    emberwatch_citizens: {
      id: 'emberwatch_citizens',
      name: 'Emberwatch Citizens',
      description:
        'The common folk of Emberwatch — farmers, craftsmen, and merchants who call this village home.',
      defaultStanding: 10,
      standingTiers: [
        { threshold: -100, tier: 'hostile', label: 'Hostile' },
        { threshold: -60, tier: 'unfriendly', label: 'Unfriendly' },
    ...
    crimson_covenant: {
      ...
      description:
        "A shadowy order of rogue mages who seek to seize the ward's power for themselves.",
      defaultStanding: -30,
      standingTiers: [
        { threshold: -100, tier: 'hostile', label: 'Hostile' },
        { threshold: -60, tier: 'unfriendly', label: 'Unfriendly' },
