...
const EMBERWATCH_FIXTURES = {
  ...
  atlas: {
    ...
    // C-378 AC-5: 1px extruded frames — 34px cell pitch, 544×340 atlas.
    ...
    // C-546: rows grew 8 → 10 to append the bridge-assembly frames.
    minFrames: 80,
    size: { w: 544, h: 340 },
    columns: 16,
    tilecount: 160,
...
describe('Emberwatch map audit (C-375 AC-5 + C-376 AC-6 fixtures)', () => {
  ...
  test('map tileset blocks match the atlas grid (544×340 extruded, 16 cols, 160 tiles)', () => {
