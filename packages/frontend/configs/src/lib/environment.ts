...
const masterSchema = Type.Object({
  ...
  PUBLIC_HUB_PAGE_URL: Type.Optional(Type.String()),
  PUBLIC_CLIENT_URL: Type.Optional(Type.String()),
...
const validateEnv = (): MasterEnv => {
  ...
  const env: MasterEnv = {
    ...
    PUBLIC_HUB_PAGE_URL: rawEnv.PUBLIC_HUB_PAGE_URL,
    PUBLIC_CLIENT_URL: rawEnv.PUBLIC_CLIENT_URL,
