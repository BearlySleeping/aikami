...
const iconPaths: Readonly<Record<string, string>> = {
  ...
  switch: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm3-13H9v2h6V7zm-6 10h6v-2H9v2z',
  'hard-drive': 'M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V6h16v12zM6 10h2v2H6v-2zm0 3h8v2H6v-2zm10 0h2v2h-2v-2zm0-3h2v2h-2v-2z',
  ...
  database: 'M12 2C8.13 2 5 4.69 5 8c0 3.31 3.13 6 7 6s7-2.69 7-6c0-3.31-3.13-6-7-6zm0 10c-2.76 0-5-1.79-5-4s2.24-4 5-4 5 1.79 5 4-2.24 4-5 4zm0 2c-3.87 0-7-2.69-7-6v2c0 3.31 3.13 6 7 6s7-2.69 7-6v-2c0 3.31-3.13 6-7 6z',
