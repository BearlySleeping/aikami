...
export type LpcAnimationState = (typeof LpcAnimationState)[keyof typeof LpcAnimationState];
...
export type LpcDirection = (typeof LpcDirection)[keyof typeof LpcDirection];
