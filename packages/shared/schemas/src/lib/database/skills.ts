...
export const SkillSchema = z.object({
	name: z.string().describe("Skill name (e.g., Athletics, Persuasion)"),
	ability: AbilityTypeSchema.describe("Associated ability score"),
	isProficient: z
		.boolean()
		.describe("Whether the character is proficient in this skill")
		.default(false),
	isExpertise: z
		.boolean()
		.describe("Whether the character has expertise (double proficiency)")
		.default(false),
});
...
export const SavingThrowSchema = z.object({
	ability: AbilityTypeSchema.describe("Ability score for the saving throw"),
	isProficient: z
		.boolean()
		.describe("Whether the character is proficient in this save")
		.default(false),
	isExpertise: z
		.boolean()
		.describe("Whether the character has expertise (double proficiency)")
...
export type SavingThrowData = z.infer<typeof SavingThrowSchema>;
