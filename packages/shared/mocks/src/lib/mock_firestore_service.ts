// packages/shared/mocks/src/lib/mock-firestore-service.ts
import type { BaseFirestoreService, QueryFilter, QueryOptions } from '@aikami/backend/firestore';
...
/**
 * Pure in-memory implementation of {@link BaseFirestoreService}.
 *
 ...
 */
export class MockFirestoreService implements BaseFirestoreService {
  // Root document store: collection path → (document id → document data)
  private store: CollectionMap = new Map();

  // -----------------------------------------------------------------------
  // Lifecycle helpers (NOT part of BaseFirestoreService — test-only)
  // -----------------------------------------------------------------------
