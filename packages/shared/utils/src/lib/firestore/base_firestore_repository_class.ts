// packages/shared/utils/src/lib/firestore/base_firestore_repository_class.ts
...
import { toCoreData } from './firestore_data_converters.ts';

export type BaseFirestoreRepositoryOptions<T extends FirestoreRepositoryType> = {
  className: string;
...
export type BaseFirestoreRepositoryInterface<T extends FirestoreRepositoryType> = {
  /**
...
export abstract class BaseFirestoreRepository<T extends FirestoreRepositoryType> extends BaseClass {
