...
type Payload<T extends Actions, Type extends MessageType<T> = MessageType<T>> = T[Type][0];

type Response<T extends Actions, Type extends MessageType<T> = MessageType<T>> = T[Type][1];
