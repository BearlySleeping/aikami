// packages/backend/firestore/src/lib/base-database-service.ts
...
// ---------------------------------------------------------------------------
// BaseFirestoreService — OOP abstraction contract
// ---------------------------------------------------------------------------
 ...
 * controllers — depend on `BaseFirestoreService`, never on a specific SDK.
 *
...
export type BaseFirestoreService = {
  /**
