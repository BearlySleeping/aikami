// packages/backend/firestore/src/lib/firebase-data-connect-service.ts
...
/**
 * {@link BaseFirestoreService} backed by **Firebase Data Connect** (Cloud SQL
 * for PostgreSQL).
 *
 ...
 */
export class FirebaseDataConnectService implements BaseFirestoreService {
